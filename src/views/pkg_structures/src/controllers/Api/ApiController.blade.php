...
class ZZZController extends Controller {
	...
	public function status(Request $request) {
		try {
			...
			if (!$user) {
				...
				return response()->json([
					'status' => false,
					'message' => 'ZZZ not found',
				], $this->successStatus);
				// return response()->json(['status' => false, 'message' => 'ZZZ not found'], $this->successStatus);
			}
	...
	public function punch(Request $request) {
		try {
			...
			//dd($user);
			if (!$user) {
				return response()->json(['success' => false, 'message' => 'ZZZ not found'], $this->successStatus);
			}
